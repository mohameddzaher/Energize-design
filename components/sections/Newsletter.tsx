  ...
  return (
    <Section background={background}>
      <div className="text-center">
        ...
        >
          {t('ابقَ على تواصل', 'Stay Connected')}
        </motion.h2>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          {t(
            'اشترك في نشرتنا البريدية للحصول على رؤى تصميمية وتحديثات المشاريع وأخبار القطاع.',
        ...
        >
          ...
          >
            {submitted ? t('تم الاشتراك!', 'Subscribed!') : t('اشترك', 'Subscribe')}
          </Button>
        </motion.form>
      </div>
    </Section>
