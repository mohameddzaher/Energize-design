...
export const projects: Project[] = [
  {
    ...
    description: 'A professionally designed boys\' bedroom that balances elegance and functionality, with smart space planning and warm details for a calm living experience.',
    images: [
  ...
  },
  {
    ...
    slug: 'girls-bedroom',
    category: 'Residential',
    description: 'A modern and elegant girls\' bedroom design that combines comfort, functionality, and style.',
    images: [
  ...
  },
  {
    ...
    slug: 'jewelry-store',
    category: 'Commercial',
    description: 'Design and renovation of a diamond store in Jeddah with a modern luxury style that highlights the brilliance of diamonds and offers customers a unique experience.',
    images: [
  ...
  },
  {
    ...
    description: 'A modern cafe design that creates a welcoming atmosphere for customers.',
    images: [
  ...
  },
  {
    ...
    slug: 'master-bedroom',
    category: 'Residential',
    description: 'A luxurious master bedroom design that combines elegance and comfort.',
    images: [
  ...
  },
  {
    ...
    slug: 'offices',
    category: 'Commercial',
    description: 'Professional office space design in Makkah that enhances productivity and creates a modern work environment.',
    images: [
  ...
  },
  {
    ...
    slug: 'studio',
    category: 'Residential',
    description: 'A modern studio design that balances elegance and functionality, with smart space planning and warm details for a calm living experience.',
    images: [
